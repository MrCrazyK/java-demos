package com.k.es.controller;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.k.es.entity.ResponseBean;
import com.k.es.entity.User;
import com.k.es.util.EsUtil;
...
public class EsController {
    ...
    public ResponseBean findIndustryClassList(@RequestBody User user, @RequestParam String indexName) {
        ...
        System.out.println(indexRequest.type());
    ...
    public ResponseBean testESFind() {
        SearchRequest searchRequest = new SearchRequest("idxuser");
...
//        TermQueryBuilder termQueryBuilder = QueryBuilders.termQuery("name.keyword", name);//精准查询
        PrefixQueryBuilder prefixQueryBuilder = QueryBuilders.prefixQuery("name.keyword", "仲**");//前缀查询
